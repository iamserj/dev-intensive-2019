...
// static extension function to format Date with given pattern
fun Date.format(pattern: String = "HH:mm:ss dd.MM.yy"): String {
    val dateFormat = SimpleDateFormat(pattern, Locale("ru"))
    return dateFormat.format(this)
}

// static extension adding or subtracting value as unit of TimeUnits
...
// static extension which formats the difference between dates (time intervals) in human-friendly words
